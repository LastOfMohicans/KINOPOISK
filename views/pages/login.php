...
<?php $view->components('start_simple'); ?>
...
<main class="form-signin w-100 m-auto">
    <form action="/login" method="post">
        ...
        <div class="form-floating mt-3">
            <input type="email" class="form-control" name="email" id="floatingInput" placeholder="name@areaweb.su">
...
<?php $view->components('end_simple'); ?>