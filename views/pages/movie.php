...
/**
 * @var \App\Kernel\Interfaces\AuthInterface $auth
 * @var \App\Kernel\Interfaces\ViewInterface $view
 * @var \App\Kernel\Interfaces\SessionInterface $session
 * @var \App\Kernel\Interfaces\StorageInterface $storage
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <?php if ($auth->check()) { ?>
                            <form action="/reviews/add" method="post" class="m-3 w-100">
                                ...
                                <select class="form-select <?php echo $session->has('rating') ? 'is-invalid' : '' ?>" name="rating" aria-label="Default select example">
                                ...
                                <div class="form-floating mt-2">
                                    <textarea class="form-control <?php echo $session->has('comment') ? 'is-invalid' : '' ?>" name="comment" placeholder="Укажи свое мнение о фильме" id="floatingTextarea2" style="height: 100px"></textarea>
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text">Оценка <span class="badge bg-warning warn__badge"><?php echo $avg ?></span></p>
                            ...
                            <div class="one-movie__reviews">
                                 <?php foreach ($reviews as $review) { ?>
                                    <?php $view->components('review_card', ['review' => $review, 'user' => $user]) ?>
                                <?php } ?> 
                            </div>
                        </div>
                    </div>
